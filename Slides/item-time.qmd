...
institute: "ottavia.epifania@unitn.it"
...
It is based on a $Z$ statistic under the null hypothesis that the area between the ICCs of the item in the two groups is 0
...
> Rows $1, \ldots, I$: Estimates of the items in the **REFERENCE GROUP**

> Rows $I, \ldots, 2I$: Estimates of the items in the **FOCAL GROUP**
...
Rows $1, \ldots, I$: These estimates **are not** rescaled
...
Download the data set "difES.csv" from the [shared folder](https://drive.google.com/drive/folders/1EF4cN4yiB3Fft_y2Mh4r0Mclxc6bTRdf?usp=sharing).

Store the downloaded file in the `data` sub folder: 

- Import the dataset

- Look at the data!

- Check of the assumptions & Models estimation & Model selection

- Item fit 

- DIF investigation with the three methods
