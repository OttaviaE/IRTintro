...
- If the one-factor model presents does not present a good fit to the data $\rightarrow$ unidimensionality is not supported, it is best to first understand the latent structure of the data
...
Monotonicitiy is evaluated at the item level with $H$ coefficient by Mokken (1971): 
