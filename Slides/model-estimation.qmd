...
This statistics is computed between the residuls of every pair of items
...
Download the data set "dataES_stima.csv" from the [shared folder](https://drive.google.com/drive/folders/1EF4cN4yiB3Fft_y2Mh4r0Mclxc6bTRdf?usp=sharing).

Store the downloaded file in the `data` sub folder: 

- Import the dataset

- Look at the data! (Both items and respondents)

- Check the monotonicity and unidimensionality assumptions

- Fit of the IRT models & choose the best model

- Check the local independence assumption

- Obtain the ICCs, IIFs, and TIF of the test
